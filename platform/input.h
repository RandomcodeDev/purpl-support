...
/// @brief Input type
PURPL_MAKE_TAG(enum, INPUT_TYPE,
               {InputTypeKeyboardAndMouse, InputTypeController,
                // TODO: vr etc
                InputTypeCount})

/// @brief Keys, based on position on QWERTY keyboard
PURPL_MAKE_TAG(enum, INPUT_KEY,
               {
                   // row 1
...
/// @brief Mouse buttons
PURPL_MAKE_TAG(enum, INPUT_MOUSE_BUTTON,
               {InputMouseButtonLeft, InputMouseButtonMiddle, InputMouseButtonRight, InputMouseButton4,
                InputMouseButton5, InputMouseButtonCount})
...
PURPL_MAKE_TAG(enum, INPUT_CONTROLLER_BUTTON,
               {InputControllerButtonA, InputControllerButtonB, InputControllerButtonX, InputControllerButtonY,

                InputControllerButtonStart, InputControllerButtonSelect,

                InputControllerButtonLeftStick, InputControllerButtonRightStick,

                InputControllerButtonUp, InputControllerButtonDown, InputControllerButtonLeft,
                InputControllerButtonRight,

                InputControllerButtonLeftTrigger, InputControllerButtonRightTrigger, InputControllerButtonLeftShoulder,
                InputControllerButtonRightShoulder,

                InputControllerButtonCount})

/// @brief Get the current state of a controller button
#define INPUT_GET_CONTROLLER_BUTTON(Button) (InState.ControllerButtons[InputControllerButton##Key])

/// @brief Input state
PURPL_MAKE_TAG(struct, INPUT_STATE, {
    INPUT_TYPE Type;
